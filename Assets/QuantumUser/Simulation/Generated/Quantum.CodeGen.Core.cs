...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct EnemyCharacter : Quantum.IComponent {
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (EnemyCharacter*)ptr;
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct EnemyHealth : Quantum.IComponent {
    ...
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    public QDictionaryPtr<EntityRef, FP> TakenDamage;
    [FieldOffset(8)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + EnemyHealthConfig.GetHashCode();
        return hash;
      }
    }
    ...
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.EnemyHealth*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (EnemyHealth*)ptr;
        QDictionary.Serialize(&p->TakenDamage, serializer, Statics.SerializeEntityRef, Statics.SerializeFP);
        AssetRef.Serialize(&p->EnemyHealthConfig, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerCharacterAttack : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    [ExcludeFromPrototype()]
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerCharacterAttack*)ptr;
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerCharacterMovement : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    [ExcludeFromPrototype()]
    public FP MovingSpeed;
    [FieldOffset(0)]
    public AssetRef<PlayerCharacterMovementConfig> MovementConfig;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 5081;
        hash = hash * 31 + MovingSpeed.GetHashCode();
        hash = hash * 31 + MovementConfig.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerCharacterMovement*)ptr;
        AssetRef.Serialize(&p->MovementConfig, serializer);
        FP.Serialize(&p->MovingSpeed, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerCharacterScore : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerCharacterScore*)ptr;
        serializer.Stream.Serialize(&p->Kills);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerCharacterTargets : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    public QDictionaryPtr<EntityRef, FP> ClosestEnemies;
    [FieldOffset(8)]
    public AssetRef<PlayerCharacterTargetsConfig> TargetsConfig;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 4871;
        hash = hash * 31 + ClosestEnemies.GetHashCode();
        hash = hash * 31 + TargetsConfig.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      ClosestEnemies = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.PlayerCharacterTargets*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerCharacterTargets*)ptr;
        QDictionary.Serialize(&p->ClosestEnemies, serializer, Statics.SerializeEntityRef, Statics.SerializeFP);
        AssetRef.Serialize(&p->TargetsConfig, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial interface ISignalOnSpawnEnemy : ISignal {
    void OnSpawnEnemy(Frame f, EntityRef entityRef);
  }
  public unsafe partial interface ISignalOnEnemyDeath : ISignal {
    void OnEnemyDeath(Frame f, EntityRef enemy, EntityRef killer);
  }
  public unsafe partial interface ISignalOnEnemyHit : ISignal {
    void OnEnemyHit(Frame f, EntityRef enemy, EntityRef source, FP damage);
  }
  public unsafe partial interface ISignalOnSpawnPlayerCharacter : ISignal {
    void OnSpawnPlayerCharacter(Frame f, EntityRef entityRef);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalOnSpawnEnemy[] _ISignalOnSpawnEnemySystems;
    private ISignalOnEnemyDeath[] _ISignalOnEnemyDeathSystems;
    private ISignalOnEnemyHit[] _ISignalOnEnemyHitSystems;
    private ISignalOnSpawnPlayerCharacter[] _ISignalOnSpawnPlayerCharacterSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnSpawnEnemySystems = BuildSignalsArray<ISignalOnSpawnEnemy>();
      _ISignalOnEnemyDeathSystems = BuildSignalsArray<ISignalOnEnemyDeath>();
      _ISignalOnEnemyHitSystems = BuildSignalsArray<ISignalOnEnemyHit>();
      _ISignalOnSpawnPlayerCharacterSystems = BuildSignalsArray<ISignalOnSpawnPlayerCharacter>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.EnemyCharacter>();
      BuildSignalsArrayOnComponentRemoved<Quantum.EnemyCharacter>();
      BuildSignalsArrayOnComponentAdded<Quantum.EnemyHealth>();
      BuildSignalsArrayOnComponentRemoved<Quantum.EnemyHealth>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerCharacterAttack>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerCharacterAttack>();
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerCharacterMovement>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerCharacterMovement>();
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerCharacterScore>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerCharacterScore>();
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerCharacterTargets>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerCharacterTargets>();
    ...
    public unsafe partial struct FrameSignals {
      public void OnSpawnEnemy(EntityRef entityRef) {
        var array = _f._ISignalOnSpawnEnemySystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnSpawnEnemy(_f, entityRef);
          }
        }
      }
      public void OnEnemyDeath(EntityRef enemy, EntityRef killer) {
        var array = _f._ISignalOnEnemyDeathSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnEnemyDeath(_f, enemy, killer);
          }
        }
      }
      public void OnEnemyHit(EntityRef enemy, EntityRef source, FP damage) {
        var array = _f._ISignalOnEnemyHitSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnEnemyHit(_f, enemy, source, damage);
          }
        }
      }
      public void OnSpawnPlayerCharacter(EntityRef entityRef) {
        var array = _f._ISignalOnSpawnPlayerCharacterSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnSpawnPlayerCharacter(_f, entityRef);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.EnemyCharacter), Quantum.EnemyCharacter.SIZE);
      typeRegistry.Register(typeof(Quantum.EnemyHealth), Quantum.EnemyHealth.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerCharacterAttack), Quantum.PlayerCharacterAttack.SIZE);
      typeRegistry.Register(typeof(Quantum.PlayerCharacterMovement), Quantum.PlayerCharacterMovement.SIZE);
      typeRegistry.Register(typeof(Quantum.PlayerCharacterScore), Quantum.PlayerCharacterScore.SIZE);
      typeRegistry.Register(typeof(Quantum.PlayerCharacterTargets), Quantum.PlayerCharacterTargets.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 8)
        ...
        .Add<Quantum.EnemyCharacter>(Quantum.EnemyCharacter.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.EnemyHealth>(Quantum.EnemyHealth.Serialize, null, Quantum.EnemyHealth.OnRemoved, ComponentFlags.None)
        .Add<Quantum.PlayerCharacter>(Quantum.PlayerCharacter.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacterAttack>(Quantum.PlayerCharacterAttack.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacterMovement>(Quantum.PlayerCharacterMovement.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacterScore>(Quantum.PlayerCharacterScore.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacterTargets>(Quantum.PlayerCharacterTargets.Serialize, null, Quantum.PlayerCharacterTargets.OnRemoved, ComponentFlags.None)
